...
class OscillatoryControlGUI(QWidget):
    def __init__(self):
        ...
        self.amplitude_sphere1 = 0.5  # m/s (velocidade máxima)
        self.amplitude_sphere2 = 0.5  # m/s
        self.amplitude_sphere3 = 0.5  # m/s
    ...
    def init_ui(self):
        ...
        self.slider_amp1.setMinimum(1)    # 0.01 m/s
        self.slider_amp1.setMaximum(100)  # 1.0 m/s
        self.slider_amp1.setValue(50)     # 0.5 m/s
        self.slider_amp1.valueChanged.connect(self.on_amp1_changed)
        
        self.spin_amp1 = QDoubleSpinBox()
        self.spin_amp1.setRange(0.01, 1.0)
        self.spin_amp1.setDecimals(2)
        self.spin_amp1.setSingleStep(0.05)
        ...
        self.slider_amp2.setMinimum(1)
        self.slider_amp2.setMaximum(100)
        self.slider_amp2.setValue(50)
        self.slider_amp2.valueChanged.connect(self.on_amp2_changed)
        
        self.spin_amp2 = QDoubleSpinBox()
        self.spin_amp2.setRange(0.01, 1.0)
        self.spin_amp2.setDecimals(2)
        self.spin_amp2.setSingleStep(0.05)
        ...
        self.slider_amp3.setMinimum(1)
        self.slider_amp3.setMaximum(100)
        self.slider_amp3.setValue(50)
        self.slider_amp3.valueChanged.connect(self.on_amp3_changed)
        
        self.spin_amp3 = QDoubleSpinBox()
        self.spin_amp3.setRange(0.01, 1.0)
        self.spin_amp3.setDecimals(2)
        self.spin_amp3.setSingleStep(0.05)
    ...
    def on_spin_amp1_changed(self, value):
        ...
        self.slider_amp1.setValue(int(value * 100))
    ...
    def on_spin_amp2_changed(self, value):
        ...
        self.slider_amp2.setValue(int(value * 100))
    ...
    def on_spin_amp3_changed(self, value):
        ...
        self.slider_amp3.setValue(int(value * 100))
